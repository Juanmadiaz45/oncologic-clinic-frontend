    ...
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4">
            ...
            <div className="flex items-center space-x-4">
              ...
              <UserDropdown username={currentUser?.username || 'Administrador'} />
            </div>
          </div>
        </div>
      </header>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600 mt-2">Panel de administración del sistema OncoLogic</p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          {managementSections.map((section, sectionIndex) => (
            <div key={sectionIndex} className="bg-white rounded-xl shadow-card border border-gray-200 overflow-hidden">
                  ...
                  {section.items.map((item, itemIndex) => (
                    ...
                    >
                      ...
                      <div className="flex items-center space-x-2">
                        ...
                        <svg className="w-4 h-4 text-gray-400 group-hover:text-clinic-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
